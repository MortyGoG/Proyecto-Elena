...
public class PantallaMostrarTestimonios extends JPanel implements ActionListener{
    ...
    public PantallaMostrarTestimonios(){
    ...
    //Mostrar la coincidencia
        if (e.getSource() == botonComenzar) {
            ...
            if(tfNombre.getText().isEmpty() || tfNombre.getText() == null){
                ...
                MostrarTestimonios MosPro = new MostrarTestimonios();
                texto = (MosPro.MostrarTestimonio(nombre));
